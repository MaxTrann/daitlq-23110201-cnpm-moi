...
const AdminProductsPage = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    const res = editingProduct ? await updateProductApi(editingProduct._id, payload) : await createProductApi(payload);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-sm">
        <Table rowKey="_id" loading={loading} columns={columns} dataSource={products} scroll={{ x: 1200 }} pagination={{ pageSize: 6 }} />
      </div>
